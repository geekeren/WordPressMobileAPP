...
public final class ItemDataUtils {
    ...
    public static List<ItemBean> getItemBeans(){
        ...
        itemBeans.add(new ItemBean(R.drawable.sidebar_purse,"我的文章",false));
        ...
        itemBeans.add(new ItemBean(R.drawable.slidebar_shuoshuo,"我的说说",false));
        itemBeans.add(new ItemBean(R.drawable.sidebar_file,"浏览记录",false));
        return  itemBeans;
    }
